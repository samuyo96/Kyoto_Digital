...
--Creación de índices en las columnas que se usarán para buscar

CREATE INDEX IDX_Clientes_Cl_ID ON Clientes (Cl_ID);

CREATE INDEX IDX_Pedidos_P_ID ON Pedidos (P_ID);

CREATE NONCLUSTERED INDEX IDX_Pedidos_State ON Pedidos (P_Cost);
